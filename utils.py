...
def check_movie_resolution(input_fasta, movie_height, matrix_margin_vertical):
    ...
    if total_min_height != 0:
        ...
        if total_min_height <= 1080:
            print("Consider rendering in Full-HD by passing the command line arguments: -w 1920 -h 1080")
        elif total_min_height <= 2160:
            print("Consider rendering in 4K resolution by passing the command line arguments: -w 3840 -h 2160")
